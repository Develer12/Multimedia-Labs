    ...
    public partial class Form1 : Form
    {
        ...
        private void ProcessFrame(object sender, EventArgs arg)
        {
            ...
            else
            {
                ...
                {
                    var gftt = new GFTTDetector(800, 0.1, 1, 10, true).Detect(frame);
                    ...
                    CvInvoke.CalcOpticalFlowPyrLK(prev, frame11, Actual, new System.Drawing.Size(10, 10), 1, new MCvTermCriteria(20, 0.03d),
