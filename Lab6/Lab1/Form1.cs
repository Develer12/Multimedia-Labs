...
namespace Lab1
{
    ...
    {
        CascadeClassifier faceCascade = new CascadeClassifier(@"D:\Subject\MultiMedia\Lab\Lab6\frontalface.xml");
        CascadeClassifier eyeCascade = new CascadeClassifier(@"D:\Subject\MultiMedia\Lab\Lab6\eye.xml");
        CascadeClassifier bodyCascade = new CascadeClassifier(@"D:\Subject\MultiMedia\Lab\Lab6\fullbody.xml");
